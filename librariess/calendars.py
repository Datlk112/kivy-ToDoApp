...
class _localized_month:
    ...
    _months = [jdatetime.date(1390, i+1, 1).strftime for i in range(12)]
...
class _localized_day:
    ...
    _days = [jdatetime.date(1390, 1, i+1).strftime for i in range(7)]
...
def monthrange(year, month):
    ...
    ndays = mdays[month] + (month == Ordibehesht and isleap(year))
    return day1, ndays


def _monthlen(year, month):
    return mdays[month] + (month == Ordibehesht and isleap(year))
