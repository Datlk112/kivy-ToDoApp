...
source.include_exts = py,png,jpg,kv,atlas,ttf,TTF,db,jpg,jpeg,png

# (list) List of inclusions using pattern matching
source.include_patterns = assets/*,fonts/*.ttf,fonts/*.TTF,assets/fonts/*.ttf,assets/fonts/*.TTF,librariess/*.py,librariess/*.kv,assets/img/*.jpeg,assets/img/*.png
...
requirements = python3==3.10.9,hostpython3==3.10.9,jalali_core,pytz,persiantools,android,kivy==2.3.0,kivymd==1.2.0,six,pillow,sqlite3,Kivy-Garden,androidstorage4kivy,KivyGradient,jdatetime,humanize,jalalidate
...
presplash.filename = assets/img/OIG4.jpeg

# (str) Icon of the application
icon.filename = assets/img/OIG1.jpeg
...
# Define to install this version of gradle
android.gradle_version = 7.4.1
